...
var conf = require("./conf"),
  _ = require("lodash"),
  KEYWORD_PREFIX = conf.get("keywordPrefix"),
  FIELD_SEPARATOR = conf.get("fieldSeparator"),
  EMPTY_FIELD_VALUE = conf.get("emptyFieldValue"),
  LINE_ENDING_REGEX = /\r\n|\n\r|\n|\r/g;
...
function serializeFields(fields) {
  ...
  _.forOwn(fields, function (value, key) {
    result += "\n" + KEYWORD_PREFIX + key + FIELD_SEPARATOR + value;
  });
