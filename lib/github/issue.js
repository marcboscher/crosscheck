...
function toItem (issue, options) {
  ...
  it.fields.source = conf.get("github.keyword");
...
function updateItem (oldItem, newItem) {
  ...
  if (!oldItem.fields.number) {
    throw new Error("oldItem.fields.number is required");
  }
  if (!oldItem.fields.owner) {
    throw new Error("oldItem.fields.owner is required");
  }
  if (!oldItem.fields.repo) {
    throw new Error("oldItem.fields.repo is required");
  }
